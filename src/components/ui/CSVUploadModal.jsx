...
//                       />
//                       <div>
//                         <h4 className="font-semibold text-blue-800">How to upload:</h4>
...
//                 {/* File Upload Area */}
//                 <div className={`mb-3 border-2 border-dashed rounded-lg p-3 text-center transition-colors ${
//                   uploading
              ...
              <Dialog.Panel className="w-full max-w-[95%] sm:max-w-md md:max-w-lg transform overflow-hidden rounded-xl sm:rounded-2xl bg-white p-4 sm:p-6 text-left align-middle shadow-xl transition-all">
                ...
                {onDownloadTemplate && (
                  <div className="mb-2 sm:mb-4 text-center">
                    <Button
                      text="Download Template & Instructions"
                      className="btn-outline-primary w-full sm:w-auto text-xs sm:text-sm px-3 sm:px-4 py-1.5 sm:py-2"
                      onClick={onDownloadTemplate}
                      icon="heroicons:document-arrow-down"
                      disabled={uploading}
                      size="sm"
                ...
                <div className="flex flex-col-reverse sm:flex-row justify-end sm:space-x-3 space-y-2 space-y-reverse sm:space-y-0 ">
                  ...
                  {onDownloadTemplate && !file && (
                    <Button
                      text="Download Template"
                      className="btn-outline-primary w-full sm:w-auto text-xs sm:text-sm px-4 py-1.5 sm:py-2"
                      onClick={onDownloadTemplate}
                      disabled={uploading}
                      size="sm"
                    />
