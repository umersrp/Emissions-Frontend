...
const Brandtable = () => {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/${user.type}/brand/get-brands`, {
          headers: {
        ...
        setUserData(response.data.brands
        );
      } catch (error) {
        console.log(error);
      }
    ...
    <>
      <Card noborder>
        <div className="md:flex pb-6 items-center">
          <h6 className="flex-1 md:mb-0 ">Brands</h6>
