...
const CompanyTable = () => {
    ...
    const fetchData = async () => {
        setLoading(true);
        try {
            const response = await axios.get(`${process.env.REACT_APP_BASE_URL}/company/Get-All-Company`, {
                headers: {
    ...
    const handleDelete = async (id) => {
        try {
            await axios.delete(`${process.env.REACT_APP_BASE_URL}/company/company-profile/${id}`, {
                headers: {
    ...
    const COLUMNS = [
        ...
        },
        {
            ...
            accessor: "totalAreaSqM",
        },
        {
            Header: "Units Manufactured Per Month",
            accessor: "unitsManufacturedPerMonth",
        },
        {
            Header: "Units Manufactured Per Annum",
        ...
        {
            Header: "Units Sold Per Annum",
            accessor: "unitsSoldPerAnnum",
        },
        {
            Header: "Electricity Generated (MWh Per Annum)",
            accessor: "electricityGeneratedMWhPerAnnum",
        },
        {
            Header: "Energy Generated (GJ Per Annum)",
            accessor: "energyGeneratedGJPerAnnum",
        },
        {
            Header: "Revenue Per Annum",
            accessor: "revenuePerAnnum",
        },
        {
                ...
                <div className="flex space-x-3 rtl:space-x-reverse">
                    <Tippy content="View">
                        <button
                            ...
                            onClick={() => navigate(`/Company-View/${cell.value}`)}
                        >
                    ...
                    <Tippy content="Edit">
                        <button
                            className="action-btn"
                            onClick={() => navigate(`/Company-Edit/${cell.value}`)}
                        >
