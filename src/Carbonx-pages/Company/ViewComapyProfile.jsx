      ...
      <div className="w-full mx-auto p-6">
        <div className="grid lg:grid-cols-3 grid-cols-1 gap-6">
          {Object.entries({
            ...
            "Production Volume (Tonne/Annum)":
              company.productionVolumeTonnePerAnnum,
            "Units Sold Per Annum": company.unitsSoldPerAnnum,
            "Electricity Generated (MWh/Annum)":
              company.electricityGeneratedMWhPerAnnum,
            ...
            <div key={label}>
              ...
              <p className="border p-2 rounded bg-gray-50">{value || "N/A"}</p>
            </div>
          ))}
        </div>
