...
//   const { getTableProps, getTableBodyProps, headerGroups, page, prepareRow, gotoPage, nextPage, previousPage, canNextPage, canPreviousPage } = tableInstance;

//   // Modify your pagination handlers
...
//       setControlledPageIndex((prev) => prev);
//     } catch (err) {
//       console.error(err);
//       toast.error("Failed to delete building");
//     }
...
//                         {headerGroup.headers.map((column) => (
//                           <th {...column.getHeaderProps(column.getSortByToggleProps())} className="table-th text-white whitespace-nowrap" key={column.id}>
//                             {column.render("Header")}
//                             <span>{column.isSorted ? (column.isSortedDesc ? " 🔽" : " 🔼") : ""}</span>
//                           </th>
//                         ))}
...
//                 onChange={(e) => {
//                   const pg = Number(e.target.value);
//                   if (pg >= 1 && pg <= pageCount) setControlledPageIndex(pg - 1);
//                 }}
//                 style={{ width: "70px" }}
//               />
//             </span>
...
//           <ul className="flex items-center space-x-3">
//             <li>
//               <button onClick={() => setControlledPageIndex(0)} disabled={controlledPageIndex === 0}>
//                 <Icon icon="heroicons:chevron-double-left-solid" />
//               </button>
//             </li>
//             <li>
//               <button onClick={() => controlledPageIndex > 0 && setControlledPageIndex(prev => prev - 1)} disabled={controlledPageIndex === 0}>
//                 Prev
//               </button>
//             </li>
...
//                   onClick={() => setControlledPageIndex(i)}
//                 >
//                   {i + 1}
//                 </button>
//               </li>
//             ))}
//             <li>
//               <button onClick={() => controlledPageIndex < pageCount - 1 && setControlledPageIndex(prev => prev + 1)} disabled={controlledPageIndex === pageCount - 1}>
//                 Next
//               </button>
//             </li>
//             <li>
//               <button onClick={() => setControlledPageIndex(pageCount - 1)} disabled={controlledPageIndex === pageCount - 1}>
//                 <Icon icon="heroicons:chevron-double-right-solid" />
//               </button>
//             </li>
//           </ul>
...
const BuildingTable = () => {
  ...
  // **Pagination handlers - set loading immediately**
  const handlePageChange = (newPageIndex) => {
    setIsPaginationLoading(true);
    setControlledPageIndex(newPageIndex);
  };
  ...
  const handlePageSizeChange = (newSize) => {
    setIsPaginationLoading(true);
    setControlledPageSize(newSize);
    setControlledPageIndex(0); // Reset to first page when changing page size
  };
