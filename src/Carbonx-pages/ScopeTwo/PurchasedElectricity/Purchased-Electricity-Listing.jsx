...
//       { Header: "Total Other Supplier Specific Electricity Purchased", accessor: "totalOtherSupplierElectricity" },
//       { Header: "On-Site Solar / Renewable Electricity Generation", accessor: "hasSolarPanels", Cell: ({ cell }) => cell.value ? "Yes" : "" },
//       { Header: "Purchased Supplier Specific Electricity", accessor: "purchasesSupplierSpecific", Cell: ({ cell }) => cell.value ? "Yes" : "" },
//       { Header: "Power Purhcase Agreements (PPAs)", accessor: "hasPPA", Cell: ({ cell }) => cell.value ? "Yes" : "" },

//       { Header: "Electricity Covered by Renewable Attributes", accessor: "hasRenewableAttribute", Cell: ({ cell }) => cell.value ? "Yes" : "" },
...
//       { Header: "Solar Consumption with Sold Attributes", accessor: "solarConsumedButSold" },

//       { Header: "Supplier-Specific Electricity", accessor: "supplierSpecificElectricity" },

//       { Header: "Electricity Purchased / Covered Under PPAs", accessor: "ppaElectricity" },
//       { Header: "Renewable Energy Attributes/Certificates", accessor: "renewableAttributesElectricity" },
...
const PurchasedElectricityListing = () => {
  ...
  const MARKET_BASED_COLUMNS = [
    ...
    { Header: "Purchased Supplier Specific Electricity", accessor: "purchasesSupplierSpecific", Cell: ({ cell }) => cell.value ? "Yes" : "" },
    { Header: "Power Purchase Agreements (PPAs)", accessor: "hasPPA", Cell: ({ cell }) => cell.value ? "Yes" : "" },
    { Header: "Electricity Purchased / Covered Under PPAs", accessor: "ppaElectricity" },
    { Header: "Renewable Energy Attributes/Certificates", accessor: "renewableAttributesElectricity" },
    { Header: "Electricity Covered by Renewable Attributes", accessor: "hasRenewableAttribute", Cell: ({ cell }) => cell.value ? "Yes" : "" },
