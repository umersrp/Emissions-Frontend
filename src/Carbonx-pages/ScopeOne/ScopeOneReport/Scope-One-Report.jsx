...
//     fugitive: fugitiveRes.data.data?.filter(
//       (item) => KYOTO_GASES.includes(item.gasName) // Only Kyoto gases
//     ) || [],
//   });
...
//   return (
//     <Card>
//       <h2 className="text-2xl font-semibold mb-4 text-gray-700">GHG Emissions</h2>
