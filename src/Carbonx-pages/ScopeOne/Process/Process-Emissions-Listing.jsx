...
// const fetchAllProcessRecords = async () => {
//   try {
//     const res = await axios.get(
//       `${process.env.REACT_APP_BASE_URL}/Process-Emissions/Get-All?limit=1000000`,
//       {
//         headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
//       }
//     );
...
//   // Handle stakeholderDepartment
//   if (column.accessor === "stakeholderDepartment") {
//     if (!value || value === "N/A") {
//       return "N/A";
//     }
...
//   // Handle amountOfEmissions
//   if (column.accessor === "amountOfEmissions") {
//     if (!value || value === "N/A") {
//       return "N/A";
//     }
//     const numValue = Number(value);
...
// <ExcelExportButton
//   data={records}
//   fetchAllData={fetchAllProcessRecords}
//   columns={COLUMNS}
//   exportFields={[
//     "buildingId.buildingCode",
//     "buildingId.buildingName",
...
const ProcessEmissionsListing = () => {
  ...
  const templateInstructions = (
    <ol className="text-sm text-black-700 space-y-1 list-decimal pl-4">
      ...
      <li>Remove unnecessary “Type of Activity” and “Process Activity Type”</li>
  ...
  <div className="mb-4 mt-4 flex justify-end">
    ...
    />
      ...
      <CSVUploadModal
        ...
        title="Bulk Upload Process Emissions Records"
        csvState={csvState}
        onFileSelect={handleCSVFileSelect}
        onUpload={handleCSVUpload}
        onReset={resetUpload}
        onDownloadTemplate={downloadProcessTemplate}
