...
import useWasteGeneratedCSVUpload from "@/hooks/scope3/useWasteGeneratedCSVUpload";
...
const WasteGeneratedListing = () => {
  ...
  } = useWasteGeneratedCSVUpload(buildings);
  ...
  const fetchAllWasteRecords = async () => {
    try {
      const res = await axios.get(
        `${process.env.REACT_APP_BASE_URL}/Waste-Generate/List?limit=1000000`,
        {
          headers: { Authorization: `Bearer ${localStorage.getItem("token")}` },
        }
      );
  ...
  return (
    <>
          ...
          <div className="md:flex md:space-x-3 items-center">
            ...
            {records.length > 0 && (
              <ExcelExportButton
                ...
                fileName="waste_generated_current_page"
            ...
            <ExcelExportButton
              data={records}
              fetchAllData={fetchAllWasteRecords}
              columns={COLUMNS}
              exportFields={[
                "buildingId.buildingCode",
                "buildingId.buildingName",
      ...
      <CSVUploadModal
        ...
        title="Bulk Upload Waste Generated Records"
        csvState={csvState}
        onFileSelect={handleCSVFileSelect}
        onUpload={handleCSVUpload}
        onReset={resetUpload}
        onDownloadTemplate={downloadWasteTemplate}
