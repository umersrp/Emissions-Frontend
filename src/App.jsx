...
import FuelFusion from "./Carbonx-pages/ScopeThree/FuelAndEnergy/fuelFusion";
import FuelEnergyForm from "./Carbonx-pages/ScopeThree/FuelAndEnergy/fuelEnergyForm";
...
import EmployeeCommutingFormCarpool from "./Carbonx-pages/EmployeeCommuting/EmployeeComutingCarpool";
      ...
      <Routes>
        <Route path="/" element={<AuthLayout />}>
          ...
          <Route path="AddfromEmployee" element={<EmployeeCommutingForm />} />
           <Route path="AddfromEmployeeCarpool" element={<EmployeeCommutingFormCarpool/>} />
